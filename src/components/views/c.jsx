      ...
      <div>
        <div className='two-columns-page'>
          ...
          <div className='half-page half border-left'>
            ...
            <p>
              A sa sortie en 1973, C a tellement révolutionné le monde de l'informatique que le système d'exploitation UNIX a été réécrit en C. <b>Quasiment tous les systèmes d'exploitation sont aujourd'hui écrits en C</b>, ainsi que la plupart des compilateurs.<br/>
